...
if(isset($_POST['Submit']))
{
  ...
  $days=$_POST['days'];
  $uptdate=$_POST['uptdate'];
  $uid=intval($_GET['uid']);
$query=mysqli_query($con,"update user set fname='$fname' ,lname='$lname' , contactno='$contact',address='$address',city='$city',package='$package',days='$days',uptdate='$uptdate' where id='$uid'");
                  ...
                  <div class="col-md-12">
                      ...
                      <p align="center" style="color:#F00;"><?php echo $_SESSION['msg'];?><?php echo $_SESSION['msg']=""; ?></p>
                          ...
                          <div class="form-group">
                             ...
                             <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">WhatsApp no. </label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="wcontact" value="<?php echo $row['wcontactno'];?>" >
                              </div>
                            </div>
                             <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Adderss </label>
                              <div class="col-sm-10">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Package </label>
                              <div class="col-sm-10">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Updation Date </label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="uptdate" value="<?php echo $row['uptdate'];?>" >
                              </div>
